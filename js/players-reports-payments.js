    ...
    <div style="max-width:720px;margin:0 auto;padding:24px 16px">
      ...
      <div style="background:#ebf8ff;border-radius:12px;padding:16px 20px;margin-bottom:20px;border-right:4px solid #2b6cb0">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:10px">
          ${[['🗓 חוגים','ניהול קבוצות לימוד שבועיות'],['🏅 נבחרות','קבוצות תחרותיות'],['🏕️ מחנות','קייטנות וחוגי חופשה'],['📋 נוכחות','רישום נוכחות לפי תאריך'],['👤 שחקנים','פרטים אישיים + הישגים'],['📅 לוח שנה','מפגשים לפי ימים']].map(([i,d]) =>
      ...
      ${section('➕','הוספת משתתף חדש','linear-gradient(135deg,#2b6cb0,#2c5282)',[
        'עבור ללשונית החוג, הנבחרת או המחנה הרלוונטי מהתפריט הצדדי',
        'לחץ על כפתור <strong>➕ הוסף משתתף</strong> (בפינה הימנית של הקבוצה)',
        'אם יש למשתתף מספר שחקן באיגוד — הכנס אותו בתיבה הכחולה למעלה ולחץ <strong>🔍 שלוף</strong>, וזה ימלא אוטומטית שם, שנת לידה, מין, מד כושר ותוקף כרטיס',
        'מלא/י את שם פרטי, שם משפחה, שנת לידה, מין (שדות חובה מסומנים *) — אם לא שלפת מהאיגוד',
        'בקטע <strong>👪 פרטי הורים</strong>: הכנס <strong>שם הורה וטלפון הורה</strong> (שני השדות חובה — אין יותר שדה מייל)',
        'לחץ <strong>➕ הוסף</strong>'
      ],[
        'לחיצה על "🔍 שלוף" ממלאת אוטומטית מד כושר ותוקף כרטיס מאתר האיגוד',
        'ניתן לשלוף נתונים גם בעריכה מאוחר יותר',
        'תהליך ההוספה זהה בדיוק בחוגים, בנבחרות ובמחנות'
      ])}
